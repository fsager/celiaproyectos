...
public class SpringXmlGenerator {
	...
	static StringBuffer sb_all=new StringBuffer();
	...
	public void makeClass (String root_package, String className) throws Exception
	{
		...
		sb_srv.append("    <bean id=\""+initCap+"Service\" class=\""+root_package+".service.impl."+className+"Service\">\r\n");
		sb_srv.append("        <property name=\"businessObject\" ref=\""+initCap+"Biz\"/>\r\n");
		sb_srv.append("    </bean>\r\n");
	}
	
	public void makeClassAllInOne (String root_package, String className) throws Exception
	{
		String initCap=className.substring(0,1).toLowerCase()+className.substring(1, className.length());

		sb_all.append("    <bean id=\""+initCap+"Dao\" class=\""+root_package+".persistence.impl."+className+"Home\">\r\n");
		sb_all.append("        <property name=\"sessionFactory\" ref=\"sessionFactory\"/>\r\n");
		sb_all.append("    </bean>\r\n");
	    
		sb_all.append("    <bean id=\""+initCap+"Business\" class=\""+root_package+".business."+className+"Biz\">\r\n");
		sb_all.append("        <property name=\"dao\" ref=\""+initCap+"Dao\"/>\r\n");
		sb_all.append("    </bean>\r\n");
	    
		sb_all.append("    <bean id=\""+initCap+"Biz\" parent=\"baseTransactionProxy\">\r\n ");
		sb_all.append("        <property name=\"target\">\r\n ");
		sb_all.append("            <ref bean=\""+initCap+"Business\"/> \r\n");
		sb_all.append("        </property> \r\n");
		sb_all.append("    </bean>\r\n");

		sb_all.append("    <bean id=\""+initCap+"Service\" class=\""+root_package+".service.impl."+className+"Service\">\r\n");
		sb_all.append("        <property name=\"businessObject\" ref=\""+initCap+"Biz\"/>\r\n");
		sb_all.append("    </bean>\r\n");
	}
	...
	public void showClassAllInOne (PrintStream os)
	{
		os.println (sb_all.toString());
	}
