 ...
 * @version 1.0
 */
public interface CelGrupoUsuarioDefinition {
	 ...
	 */
	public abstract void delete(CelGrupoUsuario p_domain) throws Exception;
	 ...
	 */
	public abstract CelGrupoUsuario get(java.io.Serializable p_Id) throws Exception;

	public abstract CelGrupoUsuario get(java.io.Serializable p_Id, String[] falseLazy) throws Exception;
	 ...
	 */
	public abstract java.util.List<CelGrupoUsuario> getAll(CelGrupoUsuario p_example, String[] falseLazy) throws Exception;
	 ...
	 */
	public abstract void insert(CelGrupoUsuario p_domain) throws Exception;
	 ...
	 * @param p_domain    p_domain
	 */
	public abstract void update(CelGrupoUsuario p_domain) throws Exception;
