 ...
 * @version 1.0
 */
public interface CelBitacoraAlumnosDefinition {
	 ...
	 */
	public abstract void delete(CelBitacoraAlumnos p_domain) throws Exception;
	 ...
	 */
	public abstract CelBitacoraAlumnos get(java.io.Serializable p_Id) throws Exception;

	public abstract CelBitacoraAlumnos get(java.io.Serializable p_Id, String[] falseLazy) throws Exception;
	 ...
	 */
	public abstract java.util.List<CelBitacoraAlumnos> getAll(CelBitacoraAlumnos p_example, String[] falseLazy) throws Exception;
	 ...
	 */
	public abstract void insert(CelBitacoraAlumnos p_domain) throws Exception;
	 ...
	 * @param p_domain    p_domain
	 */
	public abstract void update(CelBitacoraAlumnos p_domain) throws Exception;
	
    public abstract List<CelBitacoraAlumnos> getBitacoraPorUsrId(Long usrId) throws Exception;
