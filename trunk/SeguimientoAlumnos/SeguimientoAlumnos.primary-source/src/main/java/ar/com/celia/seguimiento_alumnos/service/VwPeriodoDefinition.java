 ...
 * @version 1.0
 */
public interface VwPeriodoDefinition {
	 ...
	 */
	public abstract void delete(VwPeriodo p_domain) throws Exception;
	 ...
	 */
	public abstract VwPeriodo get(java.io.Serializable p_Id) throws Exception;

	public abstract VwPeriodo get(java.io.Serializable p_Id, String[] falseLazy) throws Exception;
	 ...
	 */
	public abstract java.util.List<VwPeriodo> getAll(VwPeriodo p_example, String[] falseLazy) throws Exception;
	 ...
	 */
	public abstract void insert(VwPeriodo p_domain) throws Exception;
	 ...
	 * @param p_domain    p_domain
	 */
	public abstract void update(VwPeriodo p_domain) throws Exception;
