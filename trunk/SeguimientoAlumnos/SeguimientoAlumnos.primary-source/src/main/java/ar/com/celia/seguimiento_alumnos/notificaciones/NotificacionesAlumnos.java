...
public class NotificacionesAlumnos extends Notificaciones{
	...
	public void notificarNuevoTrabajoPractico() throws Exception {
		...
		System.out.println("Se enviaron "+cant+" de email de nuevo Trabajos Prácticos");
	}
	...
	public void notificarNuevoExamen() throws Exception
	{
		...
		System.out.println("Se enviaron "+cant+" de email de Nuevos Exámenes");
	}
...
//		}
	...
	public void notificarExamenPorVencer() throws Exception {
		...
		System.out.println("Se enviaron "+cant+" de email de Exámenes Por Vencer");
	}
	...
	public void notificarExamenVencidos() throws Exception
	{
		...
		System.out.println("Se enviaron "+cant+" de email de nuevos Exámenes Vencidos");
	}
	...
	public void notificarAlumnosPorQuedarLibresPorTP() throws Exception
	{
		...
		System.out.println("Se enviaron "+cant+" de email de Alumnos Por Quedar Libres Por TP prácticos");
	}
