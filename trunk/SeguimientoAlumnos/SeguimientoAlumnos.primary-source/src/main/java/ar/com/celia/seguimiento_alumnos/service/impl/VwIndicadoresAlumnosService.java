 ...
 * @version 1.0
 */
public class VwIndicadoresAlumnosService implements VwIndicadoresAlumnosDefinition {

	protected VwIndicadoresAlumnosDefinition biz;
	
	public VwIndicadoresAlumnosService() {

	}
	
	public void setBusinessObject (VwIndicadoresAlumnosDefinition p_biz)	{
		biz = p_biz;
	}
