 ...
 * @version 1.0
 */
public interface VwExamenDefinition {
	 ...
	 */
	public abstract void delete(VwExamen p_domain) throws Exception;
	 ...
	 */
	public abstract VwExamen get(java.io.Serializable p_Id) throws Exception;

	public abstract VwExamen get(java.io.Serializable p_Id, String[] falseLazy) throws Exception;
	 ...
	 */
	public abstract java.util.List<VwExamen> getAll(VwExamen p_example, String[] falseLazy) throws Exception;
	 ...
	 */
	public abstract void insert(VwExamen p_domain) throws Exception;
	 ...
	 * @param p_domain    p_domain
	 */
	public abstract void update(VwExamen p_domain) throws Exception;
