...
public final class Runtime
{
  ...
  public static final String LICENSE_DIRECTORY_PROPERTY = new ObfuscatedString(new long[] { 6388899238000244134L, -5180024805664342415L, -367736596541156579L, -5744200612985226406L, -3419809629710828214L, -3830138366774401580L }).toString();
  ...
  public static final String WARNING_EVALUATION = new ObfuscatedString(new long[] { -2937671592507492851L, -3102268496324167801L, 5919586344461932935L, 5212380637393923732L, -9183933033647938375L, -5639401357834602762L, 1900792064421269769L, 9104764753224514299L, -366291431641907250L, -4981951446456859208L, 4621325894282509391L, 4597809274251359252L, 320404476883389261L, 4834059445850194399L, 8189661530836744639L, 3321360458823117467L, -5649982894045768422L, 6824790053669282079L, 2913592521239689585L, 792727853396105105L, -5806058457130989498L, -9213406388190282821L, 6249188679012732153L, -5765366963941016085L, 6083980417978954274L, 5349913069684837185L, -8468607902170715087L, -231630823878680548L, -7028398969894246595L, -4717713309948778529L, -6063904821125494506L, -3266075547796484583L, -3094008223659612898L, 5979310533272008024L, -9081613057476004509L, 2696821719504131438L, 8070012780166355462L, -7898308780045792598L, 7667082605530285313L, -8372608728474611036L, -4196725015623600895L }).toString();
  private static boolean _ck;
  @SuppressWarnings("unused")
  private static final long[] KEY_SIG_CONST = { -2094697673918916784L, 9043705620287016241L, 4353964247040842695L };
  private static final String PUB_STORE = new ObfuscatedString(new long[] { 5347140503694695672L, -2050078472222786559L, -1090939667477166182L, -1614887116429751062L }).toString();
  private static final String SUBJECT = new ObfuscatedString(new long[] { -1712853941495412010L, 7139314103872750678L, 1708647545312167373L }).toString();
  @SuppressWarnings("unused")
  private static final String KEY_NODE = new ObfuscatedString(new long[] { -1178633844166344050L, 942064108562773571L, 5467556404179583502L }).toString();
  private static final String ALIAS = new ObfuscatedString(new long[] { 6186746913238977211L, 1118071448919910242L, 3268266759092267502L, 8415914926935764836L, 8050900615525030165L }).toString();
  private static final String STORE_PASS = new ObfuscatedString(new long[] { 8215178821005386738L, 3606545547696508380L, 8105569695056259631L, 8978067179702718063L, 8980164237678180832L }).toString();
  private static volatile long _uptime = -1L;
  private static final String SCHEDULE_DISABLED = new ObfuscatedString(new long[] { 5671306788677542365L, -5885525372458450988L, -4407396626133081282L, -1537455835363693899L, -6031102665156057524L, -1478170211770868218L }).toString();
  @SuppressWarnings("unused")
  ...
  private static final String UPTIME_EXP = new ObfuscatedString(new long[] { 3013278860660930162L, 4301471526854951301L, -6747772497216156675L, 5645720567963480327L, 6758055736309218282L, -1654731230014362443L, 274486467337341086L, 7040862789364547387L, 7601088371900655428L, -2636893431972966937L, -952327415151053477L, 1248377226099978011L, -524117267375531873L, -2053861175643715280L, -740110635865205725L, -2536839436544335127L, 6086939566297226655L, -5237082058524871272L, 1303639338833085497L, -6089458893752999207L, -3095527103706203994L, 3892762200748726282L, -9216442073544683168L, 2684244160057465715L, -2757286429096684263L, 3994511167925782802L, -6001272987401509012L, -8806371164062622569L, -8363562597909226838L, -6927551160336525363L, -4211670988672996905L, 5763267769455554081L, -117125249251658674L, 3683653926807866520L, -7901206021548053328L, 6018772853677880081L, -1465864270908134531L, -6931709528463852872L, 4789754509887854166L, 890869380472621700L, -4164923529230262421L, 2107536733021848521L, 1569761813715635289L, -4115748546260801472L }).toString();
  private static KeyStoreParam _keystoreParam = new KeyStoreParam()
  {
    public InputStream getStream()
      throws IOException
    {
      InputStream localInputStream = Thread.currentThread().getContextClassLoader().getResourceAsStream(Runtime.PUB_STORE);
  ...
  private static RuntimeLicenseManager _licManager = RuntimeLicenseManager.getInstance(_licenseParam);
  ...
  public static final Object init(Object paramObject)
  {
    ...
    return new RtInfo()
    {
      public void verify(Execution paramAnonymousExecution)
      {
      }

      public void verify(Session paramAnonymousSession)
      {
      }
    };
  }
  ...
  public static final boolean init(WebApp paramWebApp, boolean paramBoolean)
  {
    ...
    {
      _ck = true;
      bool1 = ((WebApps.getFeature("ee")) && ("ZK EE".equals(read("ee")))) || ("ZK PE".equals(read("pe")));
      bool1 = true;
      String str = Library.getProperty(LICENSE_DIRECTORY_PROPERTY);
      boolean bool2 = false;
      if (str != null)
      {
        bool2 = _licManager.install(str);
      }
      else
      {
        URL localURL = Runtime.class.getResource("/metainfo/zk/license/");
        if (localURL != null)
          bool2 = _licManager.install(localURL.getPath());
      }
      if (bool1)
        paramWebApp = null;
      if (bool2)
