 ...
 * @version 1.0
 */
public interface VwTrabajoPracticoDefinition {
	 ...
	 */
	public abstract void delete(VwTrabajoPractico p_domain) throws Exception;
	 ...
	 */
	public abstract VwTrabajoPractico get(java.io.Serializable p_Id) throws Exception;

	public abstract VwTrabajoPractico get(java.io.Serializable p_Id, String[] falseLazy) throws Exception;
	 ...
	 */
	public abstract java.util.List<VwTrabajoPractico> getAll(VwTrabajoPractico p_example, String[] falseLazy) throws Exception;
	 ...
	 */
	public abstract void insert(VwTrabajoPractico p_domain) throws Exception;
	 ...
	 * @param p_domain    p_domain
	 */
	public abstract void update(VwTrabajoPractico p_domain) throws Exception;
