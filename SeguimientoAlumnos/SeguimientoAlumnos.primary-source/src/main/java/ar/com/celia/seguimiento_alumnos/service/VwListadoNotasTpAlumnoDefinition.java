 ...
 * @version 1.0
 */
public interface VwListadoNotasTpAlumnoDefinition {
	 ...
	 */
	public abstract void delete(VwListadoNotasTpAlumno p_domain) throws Exception;
	 ...
	 */
	public abstract VwListadoNotasTpAlumno get(java.io.Serializable p_Id) throws Exception;

	public abstract VwListadoNotasTpAlumno get(java.io.Serializable p_Id, String[] falseLazy) throws Exception;
	 ...
	 */
	public abstract java.util.List<VwListadoNotasTpAlumno> getAll(VwListadoNotasTpAlumno p_example, String[] falseLazy) throws Exception;
	 ...
	 */
	public abstract void insert(VwListadoNotasTpAlumno p_domain) throws Exception;
	 ...
	 * @param p_domain    p_domain
	 */
	public abstract void update(VwListadoNotasTpAlumno p_domain) throws Exception;
