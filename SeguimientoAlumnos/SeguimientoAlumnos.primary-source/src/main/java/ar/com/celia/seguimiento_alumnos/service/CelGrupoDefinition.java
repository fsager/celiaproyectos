 ...
 * @version 1.0
 */
public interface CelGrupoDefinition {
	 ...
	 */
	public abstract void delete(CelGrupo p_domain) throws Exception;
	 ...
	 */
	public abstract CelGrupo get(java.io.Serializable p_Id) throws Exception;

	public abstract CelGrupo get(java.io.Serializable p_Id, String[] falseLazy) throws Exception;
	 ...
	 */
	public abstract java.util.List<CelGrupo> getAll(CelGrupo p_example, String[] falseLazy) throws Exception;
	 ...
	 */
	public abstract void insert(CelGrupo p_domain) throws Exception;
	 ...
	 * @param p_domain    p_domain
	 */
	public abstract void update(CelGrupo p_domain) throws Exception;
